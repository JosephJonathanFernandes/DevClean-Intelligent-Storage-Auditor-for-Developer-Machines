...
from .detectors import DockerBackendDetector, DockerVolumeDetector, DockerBuildCacheDetector
...
class DockerAnalyzer(Analyzer):
    def __init__(self):
        ...
        self._detectors: list[Detector] = [
            DockerBackendDetector(),
            DockerVolumeDetector(),
            DockerBuildCacheDetector()
        ]
